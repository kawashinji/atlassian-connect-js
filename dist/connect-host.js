(function (global, factory) {
  ...
  */
  ...
  queryString.parse = function (str, opts) {
  ...
  class WebItem {
    ...
    _addTriggers(webitem) {
      ...
      $(() => {
        ...
        $('head').append("<style type=\"text/css\">".concat(webitem.selector, ".ap-link-webitem {pointer-events: auto;}</style>"));
      });
    }
