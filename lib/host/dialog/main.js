...
(function (define, require, AJS, $) {
    ...
    define("ac/dialog", ["connect-host", "ac/dialog/button"], function (connect, dialogButton) {
        ...
        var keyPressListener = function keyPressListener(e) {
        ...
        return {
            ...
            */
            create: function create(options, showLoadingIndicator) {
                ...
                $nexus = $("<div />").addClass("ap-servlet-placeholder ap-container").attr("id", "ap-" + options.ns).bind("ra.dialog.close", closeDialog);
