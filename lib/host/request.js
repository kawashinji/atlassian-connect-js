...
var xhrHeaders = ['Content-Type', 'ETag'];
var requestHeadersWhitelist = ['If-Match', 'If-None-Match'];
var contextPath = null;

exports['default'] = function () {
    return {
        init: function init(xdm) {
            contextPath = xdm.cp;
        },

        internals: {
            request: function request(args, success, error) {
